    ...
    public class UsuarioController : Controller
    {
        ...
        public async Task<ActionResult<IEnumerable<RolesRespuesta>>> GetUsuarios()
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "Ocurrió un error al obtener usuarios");
            }
        }
        ...
        public ActionResult RegistrarUsuario([FromBody] UsuarioRequerido usuarioReq)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "Ocurrió un error al registrar usuario");
            }
        }
        ...
        public ActionResult Login([FromBody] LoginRequerido userReq)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "Ocurrió un error al realizar login");
            }
        }
        ...
        public async Task<IActionResult> EditUsuario(int id, UsuarioRequerido usuarioEdit)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "Ocurrió un error al editar usuario");
            }
        }
        [HttpPut, Authorize]
        public async Task<IActionResult> PasswordCambio(int id,string passwordNew)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "Ocurrió un error al cambiar contraseña");
            }
        }
        ...
        public IActionResult IsDeletedUsuario(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, "Ocurrió un error al eliminar usuario");
            }
        }
